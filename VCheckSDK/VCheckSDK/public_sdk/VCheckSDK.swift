...
public class VCheckSDK {
    ...
    private var _urlConfig: VCheckURLConfig?
    ...
    internal func getURLConfig() -> VCheckURLConfig {
        return _urlConfig ?? VCheckURLConfig.getDefaultConfig(for: getEnvironment())
    }
    ...
    public func urlConfig(config: VCheckURLConfig) -> VCheckSDK {
        self._urlConfig = config
        return self
    }
}
